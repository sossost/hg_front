...
const BgCloudWin1 =styled.div`
  ...
  background-repeat: repeat-x;
  position: absolute;
  animation: ${moveSlowlyRightforCloud3} 100s infinite linear;
  animation-direction: alternate;
`

const BgCloudWin2 =styled.div`
  top: 10%;
  left: -10%;
  width: 600px;
  height: 300px;
  ...
  background-repeat: repeat-x;
  position: absolute;
  animation: ${moveSlowlyLeftforCloud2} 100s infinite linear;
  animation-direction: alternate;
`
...
const HomePage = () => {
  //홈페이지 스타일링
  const homeIntroduceStyle:string = " w-[100vw] flex h-[400px] flex-row justify-center items-end flex-wrap relative mb-[150px] ";
  ...
  const homeFurtherIntroduceStyle:string = " w-full flex h-[400px] flex-row-reverse justify-center desktop:justify-around items-center mb-[150px] mt-[200px] desktop:mt-[30px] flex-wrap z-100 relative ";
  ...
  return (
    <div className="w-full desktop:w-[1024px] ">
      {!userLogin ? (
        <div className=" w-full flex flex-col items-center">
          <div className={`${homeIntroduceStyle}`}>
            <div className="w-full absolute overflow-hidden">
              ...
              <BgSky>
                <div className=" relative desktop:w-[1024px] w-full h-full flex flex-col items-center">
            ...
            <div className=" w-full h-full relative desktop:w-[1024px] flex flex-row justify-center desktop:justify-end">
            <div className={`${homeIntroduceTxtStyle}`}>
              <h2 className="text-base desktop:text-lg font-bold text-[#73BBFB] py-3" onClick={()=>setUserLogin(true)}>꿈꾸던 여행을 스케치하고, 꽉 잡으세요</h2>
              <p className=" text-sm desktop:text-base w-[85%] py-3 text-center">당신의 손 끝에서 꿈꾸던 여행이 펼쳐집니다. <br/>트립스케치와 함께 여행을 기록하고 공유하고 추억하세요.</p>
          ...
          <div className={`${homeFurtherIntroduceStyle}`}>
            ...
            <div className="  w-[80%] desktop:w-[40%] h-[300px] flex flex-col justify-center items-center relative">
              <div className=" rounded-full w-[200px] h-[400px] overflow-hidden relative">
                <BgSky3>
                  <BgCloudWin1></BgCloudWin1>
                  <BgCloudWin2></BgCloudWin2>
                </BgSky3>
              </div>
              <img className=" w-[300px] h-[450px] absolute justify-self-center self-center " src="/bg_planewindow.png"/>
            </div>
            <div className=" w-[80%] h-[300px] desktop:w-[50%] flex flex-col justify-center items-center">
              <p className="text-sm desktop:text-base w-[85%] py-3 leading-6 font-light text-center desktop:text-right">
        ...
        <div className=" w-full flex flex-col items-center">
          <div className=" w-[100vw] flex flex-col items-center relative">
