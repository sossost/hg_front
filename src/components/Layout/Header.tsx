...
const Header = () => {
  ...
  const headerMenuSetLayout:string = 'w-[100px] flex flex-row justify-end items-center justify-self-end';
    ...
    <div className={headerStyle.join('')}>
      <div className={headerContainerStyle.join('')}>
        ...
        <div className={headerMenuSetStyle.join('')}>
          <div className="px-1 cursor-pointer hidden desktop:flex"><Link to="/explore"><img className=" hover:bg-slate-200 rounded-xl w-[35px] p-1" src="/icon_globe.svg"/></Link></div>
